            ...
            [
              {
                stack: [
                  ...
                  {
                    text: 'Program „Przydomowe Magazyny Energii" — nabór rusza 4 września 2026 i trwa do wyczerpania środków. Wymaga systemu zarządzania energią (EMS) i pracy wyspowej. Dobieram rozwiązania, które te wymogi spełniają.',
                    color: TEXT,
                    fontSize: 9,
                    margin: [0, 4, 0, 0],
                  },
